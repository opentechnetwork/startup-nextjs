      ...
      <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src="/images/logo/otin-dark-footer.svg"
                    alt="logo"
                  ...
                  />
                  <Image
                    src="/images/logo/otin-footer.svg"
                    alt="logo"
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  ...
                  digital marketing, or e-commerce solutions.
                </p>
                <div className="flex items-center">
                  {/*<!--Facebook-->*/}
                  <a
                    href="https://www.facebook.com/opentechai"
                  ...
                  {/*<!--Linkedin-->*/}
                  <a
                    href="https://www.linkedin.com/in/david-burns-462638339/"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-lg font-bold text-black dark:text-white uppercase">
                  Policy
                </h2>
                <ul>
                  <li>
          ...
          <div className="py-8 text-center">
            ...
            <div
              className="mt-5 h-px w-full bg-gradient-to-r from-transparent via-[#D2D8E183] to-transparent dark:via-[#959CB183]"></div>
