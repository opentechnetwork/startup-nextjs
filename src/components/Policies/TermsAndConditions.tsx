...
const TermsAndConditions = () => {
  ...
  return (
    <section className="py-12 px-6">
      ...
      <p className="mb-4">
        Welcome to Open Tech Innovations. By accessing or using our website [insert website URL], you agree to comply
        with and be bound by these Terms of Use. If you do not agree with these terms, please do not use our site.
      </p>

      <h2 className="text-2xl font-semibold mb-2">1. Acceptance of Terms</h2>
      <p className="mb-4">
        By using our site, you agree to these Terms of Use and all applicable laws and regulations. You are responsible
        for compliance with any local laws.
      </p>
      ...
      <p className="mb-4">
        All content on this site, including text, graphics, logos, and images, is the property of Open Tech Innovations
        or its content suppliers and is protected by copyright laws.
      </p>

      <h2 className="text-2xl font-semibold mb-2">4. User Content</h2>
      <ul className="list-disc pl-6 mb-4">
        <li>You retain ownership of any content you post on the site, but you grant Open Tech Innovations a worldwide,
          non-exclusive, royalty-free license to use, reproduce, and distribute such content.
        </li>
      ...
      <p className="mb-4">
        Open Tech Innovations will not be liable for any damages arising from the use of this site. This includes, but
      ...
      <p className="mb-4">
        ...
        posting. Your continued use of the site following the posting of changes will constitute your acceptance of such
        changes.
      </p>

      <h2 className="text-2xl font-semibold mb-2">7. Governing Law</h2>
      <p className="mb-4">
        These terms are governed by and construed in accordance with the laws of [Your State/Country], and you
